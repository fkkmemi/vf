...
export default {
  ...
  methods: {
    ...
    update () {
      this.$axios.put('http://localhost:5000/test-vf-2-891b8/us-central1/test/12345')
        .then(r => {
    ...
    del () {
      this.$axios.delete('http://localhost:5000/test-vf-2-891b8/us-central1/test/4443333')
        .then(r => {
